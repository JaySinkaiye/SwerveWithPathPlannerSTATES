...
public class SwerveDrive extends Command {
  ...
  private double MaxSpeed = 8; // 3 meters per second desired top speed
  ...
  public SwerveDrive(CommandSwerveDrivetrain swerve, DoubleSupplier xSup, DoubleSupplier ySup, DoubleSupplier rotationSup, BooleanSupplier halfSpeed, BooleanSupplier quarterSpeed, BooleanSupplier zero, BooleanSupplier ninety, BooleanSupplier oneEighty, BooleanSupplier twoSeventy) {
    m_Swerve = swerve;
    this.ySup = ySup;
    this.xSup = xSup;
